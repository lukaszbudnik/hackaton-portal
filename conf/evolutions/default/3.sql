...
insert into roles (name, description) values ('admin', 'Administrator account - shouldnt it be i18n?');
...
insert into hackathons (subject, status, submitter_id, location_id) values ('Hackaton testowy', 'Zapisy trwają!', 1, 2);
