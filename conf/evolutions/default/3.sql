...
insert into news (title, text, labels, published, author_id) values ('Tytuł 1', 'This is an example <!--more-->of multiline news', 'label1, label2', '2012-01-01 00:00:00', 1);
...
insert into hackathons (subject, status, submitter_id, location_id) values ('Hackaton testowy 1.', 'Zapisy trwają!', 1, 1);
...
insert into hackathons (subject, status, submitter_id, location_id) values ('Hackaton testowy 2.', 'Zapisy trwają!', 1, 2);
