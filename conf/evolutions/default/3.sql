...
insert into hackathons (subject, date, description, status, organiser_id, location_id) values ('Hackaton testowy 1', '2012-01-02', '<p>Super mega hackathon!!</p> <p>Short info, etc here</p>', 1, 1, 1);
