...
#  * are applied only when app is in TEST or DEV mode
#  * do not have downs
...
insert into sponsors (name, title, description, website, sponsor_order, hackathon_id) values ('Kainos Software Ltd', 'First main sponsor', 'Some nice sponsor', 'www.google.com', 1, 1);
