 ...
 *
 */
case class SocialUser(id: UserId, displayName: String, email: Option[String], avatarUrl: Option[String], authMethod: AuthenticationMethod, oAuth1Info: Option[OAuth1Info] = None, oAuth2Info: Option[OAuth2Info] = None, hackathonUserId: Long = 0, isAdmin: Boolean = false){
}
